...
class BooksControler {
  ...
  static getOne: RequestHandler = async (req, res, next) => {
    try {
      const { id } = req.params;
  ...
  static createOne: RequestHandler = async (req, res, next) => {
    try {
  ...
  static updateOne: RequestHandler = (req, res) => {
    const { id } = req.params;
    const payload = req.body;
  ...
  static deleteOne: RequestHandler = (req, res) => {
    const { id } = req.params;
